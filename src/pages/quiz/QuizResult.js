      ...
      <div className="">
        ...
        <div className="mb- flex flex-col justify-center items-start">
          ...
          <div className="w-full flex flex-row justify-evenly">
            <p className="md:text-2xl text-xl font-bold text-teal-600">
              {correct} Correct
            </p>
        ...
        <div className="w-full h-[16vh] bg-[#996CF1] rounded-full flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center items-center"> 
             <p className="text-5xl pr-4 font-bold text-center text-white">
             {correct}
            </p>
